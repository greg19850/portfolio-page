    ...
    <div className="experience-container">
      <div className="experience">
        ...
        <div className="about-history">
          ...
          <p className='about section'>
            In my opinion most interesting about being a developer is opportunity for constant progress, hence I'm using all my free time to learn new technologies and concepts, currently learning and practicing Python and PHP. Projects section will be soon upaded with my work exmples for these two coding languages.
          </p>
        </div>
